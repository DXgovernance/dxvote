...
CACHE_TO_BLOCK=13602185 yarn hardhat run --network mainnet scripts/buildCache.ts
CACHE_TO_BLOCK=19035740 yarn hardhat run --network xdai scripts/buildCache.ts
CACHE_TO_BLOCK=2994767 yarn hardhat run --network arbitrum scripts/buildCache.ts
