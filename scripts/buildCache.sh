...
CACHE_TO_BLOCK=13632430 yarn hardhat run --network mainnet scripts/buildCache.ts
CACHE_TO_BLOCK=19115204 yarn hardhat run --network xdai scripts/buildCache.ts
